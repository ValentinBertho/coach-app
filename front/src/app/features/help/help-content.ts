    ...
    },
    {
      ...
      blocks: [
        { kind: 'list', items: [
          ...
          'Formats avancés : Classique, EMOM, AMRAP, For Time, Circuit, Isométrie, Pliométrie — la durée d\'un EMOM ou d\'un AMRAP se saisit en minutes.',
          'Types de série : drop-set, super-set, myo-reps, cluster, iso — charge et effort indépendants.',
          'Volume au choix par exercice : répétitions, durée ou distance, en valeur exacte ou en fourchette.',
          'Latéralité : les deux côtés, alterné gauche / droite, ou volume par côté.',
          'Repos strict (« 90 s ») ou en fourchette (« 90 à 120 s »), au cas par cas.',
          'Commentaire par exercice : l\'athlète le lit sur l\'exercice, au moment de le faire.',
          'Le choix des exercices se range par catégorie, avec recherche — tes catégories d\'abord, puis les types.',
        ] },
        ...
        { kind: 'text', text: 'Mettre un programme de musculation au calendrier, deux façons : une séance à la fois — ouvre le calendrier de l\'athlète, la bibliothèque latérale contient tes séances de force, glisse celle que tu veux sur le jour voulu (ou clique la case du jour puis choisis-la) ; ou tout un bloc d\'un coup — onglet Cycles, crée un cycle (semaines, séances, progression de charge), puis « Assigner » : choisis l\'athlète et la date de début, les séances de toutes les semaines se posent au calendrier.' },
        { kind: 'callout', tone: 'tip', text: 'Les charges d\'une séance planifiée sont calculées pour l\'athlète au moment où tu la poses, puis figées : le 1RM qui bougera après ne réécrit pas une séance déjà prescrite.' },
      ],
    },
    {
      id: 'calendrier',
