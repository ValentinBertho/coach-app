...
public class AthleteAccessValidator {
    ...
    public Optional<PermissionLevel> effectiveLevel(UUID coachId, UUID athleteId) {
        ...
        boolean isPrivate = referent == null || referent.isPrivate();
        ...
        // 2. Permission explicite non expirée.
        ...
        // 3. Lecture par défaut pour Owner / coach principal du club de l'athlète.
