...
| [`AUDIT-PWA-COACH-2026-08.md`](./AUDIT-PWA-COACH-2026-08.md) | **PWA mobile côté coach** : ce qui existe (socle PWA et web push complets), les dix trous du parcours mobile — le coach ne croise jamais l'invitation à installer, donc pas de push sur iPhone ; chaque notification atterrit sur un écran de bureau ; aucune donnée coach en cache. Puis une cible en trois vagues (écran « Ma journée », actions rapides, vue Jour) | 🟢 Vagues 1 et 2 livrées (coquille mobile réparée, écran « Ma journée », notifications actionnables, thème pour tous) ; vague 3 (vue Jour du calendrier, hors ligne) à faire |
