...
| Document | Angle | État |
|---|---|---|
| [`DOSSIER-JURIDIQUE-HUB-2026-09.md`](./DOSSIER-JURIDIQUE-HUB-2026-09.md) | **Ce que l'ouverture du hub soulève en droit**, écrit pour l'avocat qui la relira : ce que le code fait exactement, les neuf questions à trancher (statut de la plateforme, responsable de traitement pour les données de santé, carte professionnelle d'éducateur sportif…), et ce qui a été corrigé en attendant | 🔴 **En attente de relecture juridique.** Les textes en ligne ne sont plus faux — ils l'étaient : les CGU annonçaient que tout compte athlète naissait d'une invitation — mais ils sont provisoires et marqués comme tels |
| [`AUDIT-HUB-COACHS-ATHLETES-2026-09.md`](./AUDIT-HUB-COACHS-ATHLETES-2026-09.md) | **Ouvrir la plateforme aux coachs indépendants et aux athlètes** : compte athlète autoporté, profil coach public, annuaire, demande de coaching. Le produit sait tout faire après la poignée de main, rien avant. Deux verrous — `Athlete.club NOT NULL` et le rôle unique — et un défaut d'accès à corriger d'abord (une relation close ne révoque rien) | 🟡 Plan **validé**. Les dix décisions produit sont tranchées (§8, 4 septembre 2026) : duplication de fiche acceptée en V1, rôle unique conservé, validation manuelle des coachs, diplômes déclaratifs sans garantie, pas de messagerie avant acceptation, tarifs affichés sans paiement, pas d'avis, 16 ans minimum, historique attaché au coach, ouverture à 10 coachs publiés. **Lot 0 livré** : la révocation d'accès fonctionne enfin (clore une relation élevait l'accès du coach au lieu de le couper, et le backfill de démarrage la ressuscitait — ou empêchait l'application de booter). **Lot 5 livré** : l'inscription demande d'abord « en club ou en indépendant », le nom de club devient facultatif, et le vocabulaire « club » disparaît de l'interface d'un indépendant. **Lot 2 livré** : la vitrine du coach — fiche publique, spécialités, formules tarifaires, diplômes déclaratifs, photo ré-encodée côté serveur (l'EXIF, GPS compris, ne survit pas), cycle de validation manuelle et sa file en back-office. **Lot 3 livré** : l'annuaire public — recherche filtrée, facettes qui se grisent au lieu de rendre le vide, repli explicite quand une combinaison ne donne rien, fiche publique. **Lots 1 et 4 livrés** : le compte athlète autoporté (inscription libre, 16 ans minimum) et la mise en relation (demande, une question / une réponse, acceptation atomique qui crée la fiche et la relation privée). **La boucle du hub est fermée.** Restent les lots 6, 7, 8 et la fin de relation côté écran |
...
| [`AUDIT-COACH-INDEPENDANT-2026-08.md`](./AUDIT-COACH-INDEPENDANT-2026-08.md) | **Le produit est-il prêt pour tous les coachs ?** Le mélange privé / club est déjà supporté nativement ; on parle de « club » partout à un coach qui n'en a pas | 🟡 Ouvert. Le coach membre de deux clubs se pilote désormais depuis la fiche compte du back-office (cf. `AUDIT-ADMIN-2026-08`) ; côté coach, l'interface n'exploite toujours pas le modèle multi-club |
...
| [`AUDIT-ADMIN-2026-08.md`](./AUDIT-ADMIN-2026-08.md) | **Back-office `/admin`** : une succession d'écrans CRUD sans fiche, sans recherche globale, sans journal d'audit — et cinq routes qui n'avaient aucun appelant. La cible : un centre de pilotage utilisable sans ouvrir psql | 🟢 P0 et P1 livrés (journal d'audit, activité des comptes, pilotage par signaux, recherche globale, fiches compte et club, actions de support, garde-fous). P2 listé en fin de document |
