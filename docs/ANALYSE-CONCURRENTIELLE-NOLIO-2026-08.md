...
`docs/DEMANDES-API-GARMIN-COROS.md`, les audits fonctionnel et de bêta ouverte d'août ainsi que
celui de bêta ouverte de juillet (tous depuis retirés une fois clos, cf. historique git ; leur
reliquat vit dans `docs/PLAN-CONFORMITE-BETA-2026-08.md`), code front et back.
